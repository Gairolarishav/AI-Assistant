...
class QuoteRequest(models.Model):
    ...
    decoration_mode_id = models.CharField(max_length=255,blank=True, null=True, verbose_name="Decoration Mode ID")              
    logo_colours = models.CharField(max_length=255,blank=True, null=True, verbose_name="Logo Colours")              
    ...
    quote_status = models.CharField(max_length=100, default='not generated', verbose_name="Quote Status")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Created At")
